"""
gender/dual_control.py
=======================
The person-conditioned routing logic that is your actual architectural
contribution:
  - 1st person  -> speaker's own detected gender is authoritative
  - 2nd person  -> politeness register drives style; gender falls back to speaker
  - 3rd person  -> grammatical subject gender is authoritative (if confident),
                   else falls back to speaker, else stays unknown (never forced)
"""
