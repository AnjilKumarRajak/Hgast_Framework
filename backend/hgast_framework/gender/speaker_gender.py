"""
gender/speaker_gender.py
=========================
Audio-based speaker gender detection (wav2vec2 classifier). Lazily loaded
so importing this module never crashes on machines without the model
downloaded. For text-only backbones/evaluation, you can skip this entirely
and pass speaker_gender=-1 (unknown) into the pipeline.
"""
